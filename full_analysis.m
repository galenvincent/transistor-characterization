...
output_stats('Z:\data\180716recalc_normvt.csv',[s61, s62, s64, s65, s131, s132, s133, s134, s135, s136, s191, s193, s195, s254, s271, s273, s274, s275, s23])

data = read_database('Z:\DPP_database_wanisotropy.csv',[24:52]);

[lms, datanew] = fit_res_surf(data,1000,1);

des_op = optimize_desirability(lms,0);
